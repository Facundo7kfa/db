delimiter $$
create function FN_SERVI_ID (p_id_cliente int) returns varchar(50)
deterministic 
begin 
...
select FN_SERVI_ID(21) ;

DELIMITER $$

CREATE FUNCTION FN_MODELO_NAVE_DEL_PILOTO(piloto_id INT) RETURNS VARCHAR(20)
DETERMINISTIC
BEGIN
...
select FN_MODELO_NAVE_DEL_PILOTO(3);